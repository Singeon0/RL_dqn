...
class QNetwork(nn.Module):
    def __init__(self, env):
        ...
        conv_features = self._calculate_conv_output_size(observation_shape)
    ...
    def _calculate_conv_output_size(self, input_shape):
        ...
        conv_output = self.conv(torch.zeros(1, 1, *input_shape[1:]))
